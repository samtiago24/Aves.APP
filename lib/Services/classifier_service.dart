...
class BirdClassifier {
  ...
  Future<Map<String, dynamic>> classify(File imageFile) async {
    if (!_isLoaded || _interpreter == null) {
      throw Exception('Modelo original no cargado.');
    }
    return _runInference(imageFile, _interpreter!, labels, referenceImages);
  }
...
// ─────────────────────────────────────────────────────────────
// MODELO BIRDNET — 16 especies Tolima (BirdNET_6K_GLOBAL_MODEL.tflite)
// ─────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────
// Función compartida de inferencia
// ─────────────────────────────────────────────────────────────
Future<Map<String, dynamic>> _runInference(
  File imageFile,
  Interpreter interpreter,
  List<String> labels,
  Map<String, String> referenceImages,
) async {
